...
export class NitroMessages implements IMessageConfiguration
{
    ...
    private registerComposers(): void
    {
        ...
        this._composers.set(OutgoingHeader.CLAIM_BONUS_RARE, ClaimBonusRareMessageComposer);
        ...
        this._composers.set(OutgoingHeader.USER_SETTINGS_ALLOW_EMOJI, UserSettingsAllowEmojisComposer);
